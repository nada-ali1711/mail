...
@RestController
@CrossOrigin
public class TrashDefaultPriorityMailsController {

    @Autowired
    MailFactory mailFactory;

    @PostMapping("/deleteDefaultPriority")
    public void deleteDefaultPriority(@RequestBody MailDTO data) throws JSONException, IOException {
        ...
        String defaultFile = "D:\\" + sender + "\\DefaultMails\\defaultMails.json";

        removeJsonObjectById(defaultFile, id);
    }
